# Vendored from https://github.com/zhu-xlab/DOFA (MIT License,
# Copyright (c) 2024 Zhitong Xiong). This is the wavelength-conditioned
# dynamic patch embedding that lets a single pretrained backbone accept
# images with any number of input channels -- the whole reason DOFA is
# usable across all 4 of this project's dataset variants (3/4/5/6
# channels) with one consistent architecture.
